...
if [[ $1 = "-lyra2rev2" ]]; then
	./ccminer-xevan -a lyra2v2 -o stratum+tcp://lyra2v2.mine.zergpool.com:4533 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-equihash-ccminer" ]]; then
	./ccminer -a equihash -o stratum+tcp://zec.2miners.com:1010 -u $EQUIHASH_WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-neoscrypt" ]]; then
	./ccminer -a neoscrypt -o stratum+tcp://neoscrypt.mine.zergpool.com:4233 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-scrypt" ]]; then
	./ccminer -a scrypt -o stratum+tcp://scrypt.mine.zergpool.com:3433 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi

if [[ $1 = "-x11gost" ]]; then
	./ccminer -a x11 -o stratum+tcp://x11.mine.zpool.ca:3533 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-x17" ]]; then
	./ccminer -a x17 -o stratum+tcp://x17.mine.zergpool.com:3737 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi

if [[ $1 = "-lyra2z" ]]; then
	./ccminer -a lyra2z -o stratum+tcp://lyra2z.mine.zergpool.com:4553 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi

if [[ $1 = "-decred" ]]; then
	./ccminer -a decred -o stratum+tcp://decred.mine.zpool.ca:5744 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-blake2s" ]]; then
	./ccminer -a blake2s -o stratum+tcp://blake2s.mine.zergpool.com:5766 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-nist5" ]]; then
	./ccminer -a nist5 -o stratum+tcp://nist5.mine.zpool.ca:3833 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-lbry" ]]; then
	./ccminer -a lbry -o stratum+tcp://lbry.mine.zpool.ca:3334 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
...
if [[ $1 = "-xevan" ]]; then
	./ccminer-xevan -a xevan -o stratum+tcp://blake2s.mine.zergpool.com:3739 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi

if [[ $1 = "-phi1612" ]]; then
	./ccminer-phi -a phi -o stratum+tcp://phi.mine.zergpool.com:8333 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi

if [[ $1 = "-timetravel10" ]]; then
	./ccminer -a timetravel -o stratum+tcp://timetravel.mine.zergpool.com:3555 -u $WALLET -p [$WORKER_NAME,c=BTC] -b 4068
fi
